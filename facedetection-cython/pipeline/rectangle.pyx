...
cdef class Rectangle:
    ...
    def __cinit__(self, int x, int y, int rect_width, int rect_height, int rect_weight):
        self.x = x
        self.y = y
    ...
    cpdef Rectangle scale_rectangle(self, float scale_factor):
        # top left coord won't be changed (x,y)

        # all others will be scaled
        cdef int rect_x_scaled, rect_y_scaled, rect_width_scaled, rect_height_scaled
