...
face_image_complete = cv2.imread('sift/images/x.jpg') # group image
face_image_rgb = face_image_complete[62:62+200, 370+20:370+20+160] #cv2.imread('sift/images/y.jpg')  # face image
reference_rgb = cv2.imread('sift/images/y.jpg') # group image
...
if reference_image.shape[0] > 1200 or reference_image.shape[1] > 1200:
    ...
    face_image_complete = cv2.resize(face_image_complete,(face_image_complete.shape[0]//2,face_image_complete.shape[1]//2))
